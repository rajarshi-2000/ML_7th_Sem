...
# Hyperparameters
TOTAL_EPISODES = 5000  # Number of episodes to train the algorithm
MAX_STEPS = 150  # Max steps an agent can take during an episode
LEARNING_RATE = 0.1
GAMMA = 0.98  # Discount (close to 0 makes it greedy, close to 1 considers long term)
...
def print_frames(frames):
    ...
    for i, frame in enumerate(frames):
        ...
        print(f"Round:{i + 1}, Action:{frame['action']}, Reward: {frame['reward']}")
